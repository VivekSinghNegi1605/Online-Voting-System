  ...
  while($row = $query->fetch_assoc()){
    ...
    $(function(){
        ...
        datasets: [
          {
            ...
            strokeColor         : 'rgba(60,140,180,0.8)',
            pointColor          : '#3b8bba',
            pointStrokeColor    : 'rgba(60,140,180,1)',
            pointHighlightFill  : '#fff',
            pointHighlightStroke: 'rgba(60,140,180,1)',
      ...
      var barChartOptions                  = {
        ...
        scaleGridLineColor      : 'rgba(10,10,10,.05)',
